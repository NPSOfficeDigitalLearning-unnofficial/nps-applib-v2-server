...
type ErrorId = "notImplemented"|"unauthorized"|"notFound"|"signupEmailTaken"|"requestBodyInvalid"|"modifyNonexistentUser"|"serverError";
...
export const ERROR:{[key in ErrorId]:ErrorEnt<key>} = {
    ...
    modifyNonexistentUser: [404,"modifyNonexistentUser"],
